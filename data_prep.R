...
df_all_data <- data.frame(personid = c(75788, 60371, 57342, 47219, 13334, 12229,
                                       77105, 57342, 29183, 31502, 60371, 95883,
...
df_all_data <- data.frame(personid = c(75789, 60371, 57342, 47219, 13334, 12229,
